        ...
        {filteredWorks.map((work) => (
          ...
          >
            <div className="card-hover bg-white rounded-2xl overflow-hidden border border-gray-100">
              {/* 图片 */}
              <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200">
                {!work.image_url || work.image_url.includes('picsum') ? (
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-20 h-20 mx-auto mb-3 bg-white/60 rounded-2xl flex items-center justify-center shadow-sm">
                        <svg className="w-10 h-10 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                      </div>
                      <p className="text-orange-600/70 text-xs font-medium">点击预览 Demo</p>
                    </div>
                  </div>
                ) : (
                  <img 
